...
//    private var menuItem: MenuItem? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titlemorning.text = intent.extras!!.getString(
            FILE_TITLE,
            "PDF"
        )
...
//
//        supportActionBar?.setHomeAsUpIndicator(R.drawable.ic_action_profile_pdf)
...
//    }
    ...
    private fun downloadPdf() {
        try {
            ...
            try {
                if (isPDFFromPath) {
                    FileUtils.downloadFile(this,fileUrl!!,directoryName!!,fileName)
                } else {
